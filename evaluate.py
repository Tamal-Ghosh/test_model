...
def generate_comparison_table(all_results: Dict[str, Dict[str, Any]], target_file_path: str = "README.md"):
    ...
    markdown_content = f"""# FedPETuning: Federated Parameter-Efficient Tuning (পেপার রিপ্রোডাকশন গাইড)
...
| **PEFT Methods** | Full FT, Adapter, Prefix, LoRA, BitFit | ৫টি মেথডই পেপারের স্পেসিফিকেশন অনুযায়ী ইমপ্লিমেন্ট করা | **Exact** |
